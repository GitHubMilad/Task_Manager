    ...
    const answers = await inquirer.prompt([
      {
        ...
        validate: (value) => {
          if (value.length < 3) {
            return "The title nust contain at least 3 letters.";
          }
          return true;
        },
      },
  ...
  static async import() {
    ...
    if (fs.existsSync(answer.filename)) {
      try {
        ...
        console.log(success("data inported successfully"));
      } catch (e) {
        console.log(error(e.message));
      }
    } else {
